"""
Django settings for nickyg_computers project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-nl*z=3dw#(xi^s9+q)p8+c#m*!rs5951l9ng)a2wvrovf#@&ex')
...
ROOT_URLCONF = 'nickyg_computers.urls'
...
WSGI_APPLICATION = 'nickyg_computers.wsgi.application'
...
# WhiteNoise configuration (updated for Django 4.2+)
STORAGES = {
    "default": {
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='nickygcomputers@gmail.com')
ADMIN_EMAIL = config('ADMIN_EMAIL', default='nickygcomputers@gmail.com')
